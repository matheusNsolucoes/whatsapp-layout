...
export const Modal = styled.div`
    ...
    background: radial-gradient(circle, rgba(255, 255, 255, 1) 0%, rgba(247, 247, 247, 1) 51%);
    color: #000;
    float: left;
    display: flex;
...
export const DelayHeader = styled.div`
    ...
    background: linear-gradient(5deg, rgba(255, 202, 146, 1) 30%, rgba(255, 157, 53, 1) 100%);
    text-align: center;
    font-weight: 600;
    color: #fff;
...
export const AddNodeBtn = styled.button`
    ...
    background: linear-gradient(90deg, ${theme.accentColor} 0%, ${theme.accentColor} 100%);
    border: none;
    ...
    ::before {
        ...
        border: 6px solid ${theme.accentColor};
