...
import { Container, Background, ModalBox, ContactNameInput, SaveContactBtn, ContactEmailInput } from './styles';
    ...
    return (
        <Container>
            ...
            <ModalBox>
                ...
                <small>É preciso informar um número de telefone para criar um contato</small>
                <form onSubmit={addContact}>
                    ...
                    <small className="numberInfo">
                        ...
                        Números brasileiros com DDD maior que 28 possuem apenas 8 dígitos no WhatsApp
                    </small>
                    <InputMask
                        mask="+99 (99) 9999-9999"
                        placeholder="+__ ( ) ____-____"
                        onChange={(e) => setContactNumber(e.target.value.replace(/[\W_]/g, ''))}
                    />
                    <ContactEmailInput
                        type="email"
                        placeholder="Email.."
