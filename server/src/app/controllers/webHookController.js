        ...
        case 'message':
            if (req.body.body.key.fromMe == false) {
                ...
                if (req.body.body.message.conversation) {
                    ...
                    const dest = path.resolve(__dirname, '..', '..', '..', 'tmp', 'uploads', `${hashedBuffer}.jpg`);
                    ...
                    await livechat.saveReceiverMsg({
                        ...
                        quotedMessage: req.body.body.message.extendedTextMessage.contextInfo.quotedMessage.conversation,
                        from: req.body.body.key.remoteJid.split('@')[0],
                        to: req.body.instanceKey,
                        chatId: chatId,
                        read: false,
